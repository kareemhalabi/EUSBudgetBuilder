...
public final class OldUtil {
    protected static Log log = LogFactory.getLog(OldUtil.class);
            ...
            for(int i = 1; i < collection.size(); i++){
                ...
                for( int j = 0; j < rowCollection.getCells().size(); j++){
                    ...
                    if( !cell.isEmpty() ){
                        ...
                        cloneCell( srcRow.getCell( cell.getHssfCell().getCellNum() ), destCell, false);
                    }
                }
            }
        }
...
//                            destRow.getRowNum() + mergedRegion.getRowTo() - mergedRegion.getRowFrom(), mergedRegion.getColumnTo() );
    ...
    public static void copySheets(HSSFSheet newSheet, HSSFSheet sheet) {
        ...
        for(int i = sheet.getFirstRowNum(); i <= sheet.getLastRowNum(); i++){
            ...
            if( srcRow != null ){
                OldUtil.copyRow( sheet, newSheet, srcRow, destRow);
